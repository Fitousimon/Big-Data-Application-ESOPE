...
public class RegressionNaiveBayes extends ClassificationModel implements Algorithm {
	...
	public RegressionNaiveBayes(DataBase dataBase, int n) {
		super(dataBase, n);
		this.algorithm();
	}
	...
	public void algorithm() {
		...
		if (!this.infeasibleNaiveBayes()) {
			...
			new NaiveBayes();
			NaiveBayesModel model = NaiveBayes.train(getDataBase().getTrainingData().rdd());
